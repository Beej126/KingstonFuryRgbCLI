...
namespace FuryControllerService
{
    ...
    public class Log
    {
        ...
        public static bool IsCreateConsole { get; set; } = false;
        ...
        IL_00A6:
            ...
            _ = IsCreateConsole && (AttachConsole(-1 /*ATTACH_PARENT_PROCESS*/) || AllocConsole());
        ...
        private static readonly object Liblocker = new object();
        ...
        private static readonly string sSaveLEDProfilePath = string.Format("{0}\\FuryController_profile.log", AppDomain.CurrentDomain.BaseDirectory);

        // Token: 0x04000130 RID: 304
        private static readonly string sSaveLEDColorTableCachePath = string.Format("{0}\\FuryController_colortable_cache.log", AppDomain.CurrentDomain.BaseDirectory);

        // Token: 0x04000131 RID: 305
        private static readonly string sSaveLEDBGColorCachePath = string.Format("{0}\\FuryController_bgcolor_cache.log", AppDomain.CurrentDomain.BaseDirectory);
        ...
        private static readonly int Log_MaxSize = 5242880;
    }
}
